  ...
  return (
    <Layout>
      ...
      <div className="p-6 space-y-6 max-w-3xl">
        ...
        {/* SECCIÓN 1: MOTOR ETL - Solo visible para DBA (admin) */}
        {userRole === 'admin' && (
        ...
        {/* SECCIÓN 3: SEGURIDAD - Solo visible para DBA (admin) */}
        {userRole === 'admin' && (
          <Card className="card-gradient border-border/50">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
        ...
        {/* SECCIÓN 4: PROGRAMACIÓN (SCHEDULER) - Solo visible para DBA (admin) */}
        {userRole === 'admin' && (
          <Card className="card-gradient border-border/50">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
        ...
        {/* BOTONERA DE ACCIONES - Solo visible para DBA (admin) */}
        {userRole === 'admin' && (
